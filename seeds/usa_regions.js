  ...
  return knex('regions_table').del()
    .then(function () {
      ...
      return knex('regions_table').insert([
        ...
        {'regions_name':'east north centeral','country_id':8,'confirmed_cases':'69','deaths':'0','date_of_case':'03/16/2020'},
        {'regions_name':'west north centeral','country_id':8,'confirmed_cases':'42','deaths':'1','date_of_case':'03/16/2020'},
